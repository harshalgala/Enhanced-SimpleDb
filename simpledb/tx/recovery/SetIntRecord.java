...
class SetIntRecord implements LogRecord {
	 ...
	 *            the old value
	 */
	public SetIntRecord(int txnum, Block blk, int offset, int newval, int oldval) {
		this.txnum = txnum;
		this.blk = blk;
		this.offset = offset;
		this.newval = newval;
	...
	public int writeToLog() {
		Object[] rec = new Object[] { SETINT, txnum, blk.fileName(), blk.number(), offset, newval, oldval };
	...
	public String toString() {
		return "<SETINT " + txnum + " " + blk + " " + offset + " " + newval + " " + oldval + ">";
	}
